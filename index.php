...
<head>
  <title>Travel &mdash; Tourinsm | Saffronorld </title>
  <meta charset="utf-8">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-5" data-aos="fade-right">
              <h1 class="mb-3 text-white">Welcome to Saffron World- Your Gateway to Kashmir
              </h1>
        ...
        <div class="row align-items-center">
          <div class="col-md-6">
            <div class="heading-39101 mb-5">
              <span class="backdrop">Travel</span>
              <span class="subtitle-39191">Saffron World</span>
              <h3>Travel with us</h3>
            </div>
            <p>Let Saffron World be your trusted companion in exploring the unparalleled beauty and culture of Kashmir.
            </p>
            <p>Experience the breathtaking beauty of Kashmir (the crown jewel of India) with our exclusive curated
              travel packages. From snow-capped mountains to serene lakes, lush meadows and vibrant culture, Kashmir
              offers an unforgettable journey for every traveler. Whether you're seeking peace, adventure, romance or
              relaxation, we have the perfect itinerary for you. </p>
          </div>
        ...
        <div class="row align-items-center">
          <div class="col-md-6">
            <div class="heading-39101 mb-5">
              <span class="backdrop">Travel</span>
              <span class="subtitle-39191">Saffron World</span>
              <h3>Why Travel with Saffron World?</h3>
            </div>
            <p>
            <ul>
              <li class="con1"><span style="font-weight:700 ! important">Exclusive & Customizable Packages:</span>
                Whether it's a romantic escape, an adventure-filled trip or a luxurious retreat, we tailor itineraries
                to match your travel style.</li>
              <li class="con1"><span style="font-weight:700 ! important">Premium Comfort & Safety:</span> We prioritize
                your comfort and security, offering well-vetted accommodations and reliable transport.</li>
              <li class="con1"><span style="font-weight:700 ! important">Local Expertise:</span> Guided tours by
                knowledgeable professionals.</li>
              <li class="con1"><span style="font-weight:700 ! important">24/7 Support:</span> Dedicated assistance
                throughout your journey.</li>
              <li class="con1"><span style="font-weight:700 ! important">Seamless Travel Experience:</span> From
                planning to execution, we handle everything with precision, allowing you to relax and enjoy every moment
                of your trip.</li>
              <li class="con1"><span style="font-weight:700 ! important">Best Prices Guaranteed:</span> Affordable
                luxury for a memorable Kashmir experience.</li>
              <li class="con1"><span style="font-weight:700 ! important">Unmatched Value & Transparency:</span> We offer
                competitive prices with no hidden charges, ensuring the best value for your money.</li>
            </ul>
            </p>
          </div>
          <div class="col-md-6" data-aos="fade-right">
            <img src="images/why-travel.jpg" alt="Image" class="img-fluid" style="border-radius:12px;">
            <!-- image la fix kar dighe -->
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="price-cards-container">  
        ...
        <div class="plan">  
            <div class="inner">  
                <span class="pricing">  
                    <span>  
                        ₹60,000/- <small>for 7 peoples</small>  
                    </span>  
                </span>  
                <br>  
                <p class="title">KASHMIR 5N/6D Trip Package</p>  
                <p class="info">  
                    <strong>Price:</strong> ₹60,000 for 7 Peoples<br>  
                    <strong>Group Size:</strong> 7 Peoples<br>  
                ...
                <ul class="features">  
                    ...
                    <li>  
                        ...
                        <span>Pick-up and drop-off (Airport/Railway Station)</span>  
                    </li>  
                    <li>  
                        <span class="icon">  
                            <svg height="24" width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">  
                ...
                <p class="alert alert-danger">  
                    <strong><span style="color:red">Book Now!</span> Limited-time offer valid until 25th February</strong>  
                </p>  
                <div class="action">  
